...
@Component({
    selector: 'app-view-internal-charge-modal',
    imports: [
        CommonModule,
        SharedModule,
        RouterModule
    ],
    templateUrl: './view-internal-charge-modal.component.html',
    styleUrl: './view-internal-charge-modal.component.scss',
    animations: [fadeIn]
})
export class ViewInternalChargeModalComponent implements OnInit {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<ViewInternalChargeModalComponent>,
